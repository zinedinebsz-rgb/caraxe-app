...
const ADMIN_PROFILE_FIELDS = 'id, email, full_name, role, client_tier, phone, company, city, country, avatar_url, onboarding_done, monthly_volume, years_active, has_existing_suppliers, preferred_categories, created_at, updated_at'
